...
from crysbfn.common.callbacks import EMACallback
...
def generation(model:CrysBFN_PL_Model, num_batches_to_sample, num_samples_per_z,
...
def structure_prediction(loader, model:CrysBFN_CSP_PL_Model, num_evals, args=None):
    frac_coords = []
    num_atoms = []
    atom_types = []
    lengths = []
